...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        colorBox1 = new ColorBox(1, controller, historyGui);
        colorBox2 = new ColorBox(2, controller, historyGui);
        colorBox3 = new ColorBox(3, controller, historyGui);
        ...
        checkBox.setOnAction(event -> {
            ...
            historyGui.setLines(controller.getHistoryList());
        });
        ...
        historyGui.setOnItemClick(selectedItem -> {
            int index = historyGui.getListView().getSelectionModel().getSelectedIndex();
            controller.setCurrentState(selectedItem, index);
            historyGui.setLines(controller.getHistoryList());
        });
